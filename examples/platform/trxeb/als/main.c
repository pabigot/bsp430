...
void main ()
{
  ...
  /* Power the ALS */
  BSP430_PLATFORM_TRXEB_ALS_PORT_HPL->dir |= BSP430_PLATFORM_TRXEB_ALS_PWR_PORT_BIT;
  BSP430_PLATFORM_TRXEB_ALS_PORT_HPL->out |= BSP430_PLATFORM_TRXEB_ALS_PWR_PORT_BIT;
