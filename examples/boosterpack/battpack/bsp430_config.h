...
#elif (BSP430_PLATFORM_EXP430FR5969 - 0)
#define APP_BQ27510_I2C_PERIPH_HANDLE BSP430_PERIPH_EUSCI_B0
#define configBSP430_HAL_EUSCI_B0 1
#define configBSP430_HPL_PORT4 1
#define APP_CHGn_PORT_PERIPH_HANDLE BSP430_PERIPH_PORT4
#define APP_CHGn_PORT_BIT BIT2
#define APP_ENn_PORT_PERIPH_HANDLE BSP430_PERIPH_PORT4
#define APP_ENn_PORT_BIT BIT3
#define configBSP430_HPL_PORT2 1
#define APP_PGn_PORT_PERIPH_HANDLE BSP430_PERIPH_PORT2
#define APP_PGn_PORT_BIT BIT2
#endif
