...
#define APP_TSL2561_I2C_PERIPH_HANDLE BSP430_PERIPH_USCI5_B3
#define configBSP430_HAL_USCI5_B3 1
#elif (BSP430_PLATFORM_EXP430F5529 - 0)
#define APP_TSL2561_I2C_PERIPH_HANDLE BSP430_PERIPH_USCI5_B0
#define configBSP430_HAL_USCI5_B0 1
#elif (BSP430_PLATFORM_EXP430F5529LP - 0)
#define APP_TSL2561_I2C_PERIPH_HANDLE BSP430_PERIPH_USCI5_B1
...
#define APP_TSL2561_I2C_PERIPH_HANDLE BSP430_PERIPH_EUSCI_B0
#define configBSP430_HAL_EUSCI_B0 1
#else
#define APP_TSL2561_I2C_PERIPH_HANDLE BSP430_PERIPH_USCI_B0
#define configBSP430_HAL_USCI_B0 1
#endif

/* Address for the thing.  0x29 when ADDR is GND, 0x39 when ADDR
 * floats, 0x49 when ADDR is 3V3. */
#define APP_TSL2561_I2C_ADDRESS 0x29
