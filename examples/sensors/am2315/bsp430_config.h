...
#define APP_AM2315_I2C_PERIPH_HANDLE BSP430_PERIPH_USCI5_B3
#define configBSP430_HAL_USCI5_B3 1
#elif ((BSP430_PLATFORM_EXP430F5529 - 0) \
       || (BSP430_PLATFORM_SURF - 0))
#define APP_AM2315_I2C_PERIPH_HANDLE BSP430_PERIPH_USCI5_B0
#define configBSP430_HAL_USCI5_B0 1
#elif (BSP430_PLATFORM_EXP430F5529LP - 0)
#define APP_AM2315_I2C_PERIPH_HANDLE BSP430_PERIPH_USCI5_B1
...
#define APP_AM2315_I2C_PERIPH_HANDLE BSP430_PERIPH_EUSCI_B0
#define configBSP430_HAL_EUSCI_B0 1
#else
#define APP_AM2315_I2C_PERIPH_HANDLE BSP430_PERIPH_USCI_B0
#define configBSP430_HAL_USCI_B0 1
#endif
/* Address for the thing. */
#define APP_AM2315_I2C_ADDRESS 0x5c
