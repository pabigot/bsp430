...
#define SHOW_STATE(msg_) do {                                           \
  ...
  vBSP430serialSetReset_ni(i2c_a, 1);
  vBSP430serialSetReset_ni(i2c_b, 1);
  iBSP430i2cSetAddresses_ni(i2c_a, 'A', 'B');
  iBSP430i2cSetAddresses_ni(i2c_b, 'B', 'A');
  ...
  vBSP430serialSetReset_ni(i2c_a, 0);
  vBSP430serialSetReset_ni(i2c_b, 0);
